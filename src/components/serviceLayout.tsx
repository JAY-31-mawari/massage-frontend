            ...
            <div className="listing-caption-wrapper px-3">
                <div className="listing-detail-wrapper">
                    <div className="listing-short-detail-wrap">
                        <div className="listing-short-detail">
                            ...
                            <h4 className="listing-name fw-semibold fs-6 mb-2 mt-3"><Link to={`/single-property-1/${item._id}`} className="prt-link-detail">{item.businessName}</Link></h4>
                ...
                <div className="price-features-wrapper d-flex align-items-center justify-content-between my-4">
                    <div className="listing-short-detail-flex">
                        <h6 className="listing-card-info-price text-primary ps-0 m-0">$ 150</h6>
                    </div>
