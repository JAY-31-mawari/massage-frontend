                ...
                <div className="col-lg-3 col-md-4">
                    <div className="footer-widget">
                        <Link className="nav-footer-logo" to="/">
                            ...
                            </span><h5 className="fs-2 fw-bold text-light ms-1 my-0">LMW</h5>
                        </Link>
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-6 col-md-6">
                        <p className="mb-0">© {new Date().getFullYear()} LMW. Develop with <i className="fa-solid fa-heart ms-1 text-danger"></i>  By <Link to="https://shreethemes.in/" target="_blank">Jay</Link></p>
                    </div>
