        ...
        <div className="row">
          <div className="col-lg-3 col-md-4">
            <div className="footer-widget">
              <Link className="nav-footer-logo" to="/">
                ...
                <h5 className="fs-2 fw-bold text-light ms-1 my-0">LMW</h5>
              </Link>
          ...
          <div className="col-lg-2 col-md-4">
            <div className="footer-widget">
              ...
              <ul className="footer-menu">
                <li>
                  <Link to="/service/physiotherapy">Physiotherapy</Link>
                </li>
                <li>
                  <Link to="/service/chiropractic">Chiropractic Care</Link>
                </li>
                <li>
                  <Link to="/service/massage">Massage Therapy</Link>
                </li>
                <li>
                  <Link to="/service/acupuncture">Acupuncture</Link>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-md-6">
            <div className="footer-widget">
              ...
              <ul className="footer-menu footer-social">
                ...
                <li>
                  <Link to="https://x.com/shreethemes" target="_blank">
                ...
                <li>
                  <Link
                    to="https://www.linkedin.com/company/shreethemes"
                    target="_blank"
                  >
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6 col-md-6">
              <p className="mb-0">
                © {new Date().getFullYear()} LMW. Develop with{" "}
                <i className="fa-solid fa-heart ms-1 text-danger"></i> By{" "}
                <Link to="https://shreethemes.in/" target="_blank">
                  Jay
                </Link>
              </p>
            </div>
