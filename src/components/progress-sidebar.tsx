...
const ProgressSidebar: React.FC<ProgressSidebarProps> = ({
  ...
  return (
    <div className="w-80 px-8 py-10 bg-gradient-to-br from-indigo-50 via-white to-purple-50 border-r border-indigo-100 shadow-sm h-full">
      <div className="mb-8">
      ...
      <div className="relative">
        ...
        <div
          className="absolute left-6 top-8 w-0.5 bg-gray-200"
                    ...
                    <div
                      className={`h-full transition-all duration-700 ease-out rounded-full ${
                        isCompleted
                          ...
                          : isActive
                          ? "bg-gradient-to-r from-indigo-400 to-purple-400 w-2/3"
                          : "bg-transparent w-0"
                      }`}
                    />
                  </div>
