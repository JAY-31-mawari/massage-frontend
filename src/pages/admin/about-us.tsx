...
export default function AboutUs() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <div className="text-white min-h-[480px] bg-gradient-to-t from-emerald-700 via-emerald-500 to-emerald-400 flex flex-col justify-center items-center px-4 text-center">
