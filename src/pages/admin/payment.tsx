                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                      <div className="form-group">
                        <label>
                          FullName<i className="req">*</i>
                        </label>
                        <input
                          type="text"
                          className="form-control"
                          value={paymentCard?.cardHolderName || "Calvin"}
                        />
                      </div>
                    </div>
              ...
              <div className="checkout-wrap">
                <div className="checkout-head">
                  <div className="success-message">
                    ...
                    <p>
                      A confirmation mail send to your email, Check your inbox.
                    </p>
                  </div>
                </div>
                <div className="checkout-body">
                  <div className="row">
                    <div className="col-md-12 col-lg-12">
                      <ul className="booking-detail-list">
                        <li>
                          Booking ID/Num.<span>#BK1254872</span>
                        </li>
                        <li>
                          First Name<span>Calvin</span>
                        </li>
                        <li>
                          Last Name<span>Carlo</span>
                        </li>
                        <li>
                          Email<span>resido@gmail.com</span>
                        </li>
                        <li>
                          Phone<span>91 235 458 7458</span>
                        </li>
                        <li>
                          City<span>California</span>
                        </li>
                        <li>
                          Contry<span>United State</span>
                        </li>
                        <li>
                          Location<span>New Besil, Liverpool</span>
                        </li>
                        <li>
                          Zip<span>215467</span>
                        </li>
                      </ul>
                      <hr />
